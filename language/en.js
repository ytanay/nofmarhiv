module.exports = {
    ...
    'copyright-text': 'Copyright &copy; Levin Nof Marhiv ' + (new Date).getFullYear(),
    ...
    'couples-family-cabin-occupancy': 'Houses <strong>4</strong> people',
    'couples-vacation-apartment-occupancy': 'Houses <strong>2</strong> people (+ child)',

    'family-suite-description': 'Built out of wood and stone.',
    'couples-suite-description': 'Newly renovated and redesigned',

    'kitchenette-title': 'Stocked kitchenette',
    'kitchenette-description': '(with a microwave oven, fridge, coffee/tea, milk, juice & fruit)',
    ...
    'pricing-season-duration': '(In season pricing is effected during July, August, and school holidays)',
